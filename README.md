...
./target/release/parachain-collator -d local-test --validator --ws-port 9945 --port 40333 --parachain-id 100 -- --chain dex_raw.json --port 40444 --bootnodes=/ip4/127.0.0.1/tcp/30333/p2p/12D3KooWNvB9rzENgxaxbj72osHGk4dVeUiYvWkauC3TUQC7p5tc
```
